...
def main():
    ...
    for second_transform_int in range(4):
        if second_transform_int != transform_int:
            ...
            ## i.e. save_root = f"{project_root}/weights/NVP/dual-transform/run_test"
            ## instead of
            ## save_root = f"{project_root}/weights/NVP/dual-transform"
            ## This is done to avoid the dual-transform models from being overwritten by accident
            save_root = f"{project_root}/weights/NVP/dual-transform/run_test/{transform_int}-{second_transform_int}"
            ...
            detector = NVPResnetClassifierDualtransform(
                batch_size=dataset_batch_size,
                ...
                use_transform=(transform_int,second_transform_int),
            )
