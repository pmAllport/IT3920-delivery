...
def main():
    ...
    ## i.e. save_root = f"{project_root}/weights/NVP/combined/run_test"
    ## instead of
    ## save_root = f"{project_root}/weights/NVP/combined"
    ## This is done to avoid nvp.pt from being overwritten by accident
    save_root = f"{project_root}/weights/NVP/combined/run_test"
    ...
    torch.save(trainer.model.state_dict(), f"{save_root}/nvp.pt")
